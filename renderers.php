...
// Pull in the inital renderer - in this example a course renderer
require_once($CFG->dirroot . '/course/renderer.php');

// overriding renderer class - ,make sure the render class names are accurate
class theme_tabitha_core_course_renderer extends core_course_renderer {
  /**
